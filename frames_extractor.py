...
if __name__ == "__main__":
    ...
    parser.add_argument("--interval", type=float, default=1.0, help="Time interval between extracted frames (in seconds).")
    parser.add_argument("--face-size", type=int, default=100, help="Minimum face detection size.")
    parser.add_argument("--detection-quality", type=int, default=5, help="Face detection quality, higher is better quality.")
